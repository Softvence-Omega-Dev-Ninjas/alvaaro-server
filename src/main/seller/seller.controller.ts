...
export class SellerController {
	...
	@UseGuards(AuthGuard, RolesGuard)
	@Roles(UserRole.USER)
	async verifyOtpAndCreate(@Body() createSellerDto: CreateSellerDto, @Req() req: Request) {
		return await this.sellerService.createSeller(createSellerDto, req["userid"] as string, req["email"] as string)
	}
	...
	contactSeller(@Param("productId") productId: string, @Body() contactSellerDto: ContactSellerDto) {
