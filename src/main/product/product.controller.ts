import { Controller, Patch, Param, Body, Get, Query, Delete, NotFoundException, Post, UseGuards, Req } from "@nestjs/common"
...
export class ProductController {
	...
	toggleWishlist(@Param("productId") productId: string, @Req() req: { userid: string }) {
